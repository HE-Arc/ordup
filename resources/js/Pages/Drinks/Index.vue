  ...
  <breeze-authenticated-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex mt-8 ml-5">
            ...
            <Link href="#" class="ml-auto rounded bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create command</Link>
        </div>


        <div class="flex-none md:flex m-8 mx-auto justify-center">
            <div v-for="drink in drinks" :key="drink.id"
                class="w-auto md:w-40 border-2 border-blue-400 rounded-lg m-4 bg-blue-100">
